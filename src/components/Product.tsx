    ...
    return (
        <div key={props.id} className=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="px-5 pb-5">
                <a href="#">
                    <h5 className="text-sm font-medium text-gray-900">{props.title}</h5>
                </a>
                ...
                <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-900">{props.price}€</span>
                    <Button
                        size='md'
                        text='Add'
                        variant='primary'
                        onClick={() => addNewProduct(props.id)}
                    />
                </div>
            </div>
        </div>
